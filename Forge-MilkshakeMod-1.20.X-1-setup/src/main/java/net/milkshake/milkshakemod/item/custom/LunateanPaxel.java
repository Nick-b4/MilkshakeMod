...
public class LunateanPaxel extends DiggerItem {
	...
	public LunateanPaxel(Tier tier, Float damage) {
		super(damage, -2.8f, tier, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().stacksTo(1));
	}
