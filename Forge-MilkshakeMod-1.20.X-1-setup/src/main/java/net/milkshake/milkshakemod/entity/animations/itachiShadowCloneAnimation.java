...
public class itachiShadowCloneAnimation {
	public static final AnimationDefinition ITACHI_IDLE = AnimationDefinition.Builder.withLength(2.5F).looping()
	...
	public static final AnimationDefinition ITACHI_WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
		...
		.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-20.0F, 2.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(10.0F, 2.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(2.0F, KeyframeAnimations.degreeVec(-20.0F, 2.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
