 ...
 * @author Author
 */
public class rootanimation {
	public static final AnimationDefinition root_walk = AnimationDefinition.Builder.withLength(2.0F).looping()
	...
	public static final AnimationDefinition root_attack_animation = AnimationDefinition.Builder.withLength(1.0F)
		.addAnimation("leftarm", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-25.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
