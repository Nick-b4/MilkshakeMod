...
public class RootEntity extends Monster { 
    public RootEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    private final ServerBossEvent bossEvent =
            (ServerBossEvent) new ServerBossEvent(Component.literal("Root"), BossEvent.BossBarColor.GREEN, BossEvent.BossBarOverlay.PROGRESS).setPlayBossMusic(true).setDarkenScreen(true).setCreateWorldFog(true);
